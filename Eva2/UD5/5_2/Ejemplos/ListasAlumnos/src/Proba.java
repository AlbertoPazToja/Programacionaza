...
public class Proba {
    public static void main(String[] args) {
        ...
        Iterator<Alumno> it = listaxe.iterator();
        for (; it.hasNext();) { // Pódese facer tamén cun while. (y sería más lógico)
            Alumno al = (Alumno) it.next(); // !!! ES COMO EL FOREACH, VA UNO POR UNO Y LO ASIGNA A UNA VARIABLE al, QUE
                                            // LA IMPRIME EN CADA VUELTA
        ...
        posicion = listaxe.indexOf(new Alumno("45454545D", "Paz", "Segundo", 19));
        listaxe.remove(posicion);
        ...
        // Creamos unha segunda lista (está creada arriba pero está baleira)
