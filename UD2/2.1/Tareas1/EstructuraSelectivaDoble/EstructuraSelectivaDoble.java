...
public class EstructuraSelectivaDoble {
    ...
    public static void main(String[] args) {
        ...
        if (numero1 < numero2) { // Si el primer número es menor que el segundo, va a aparecer en pantalla el
                                 // primer número

            System.out.println(numero1 + " es el número más pequeño de los dos");
        }

        if (numero2 < numero1) { // Si el segundo número es menor que el primero, va a aparecer en pantalla el
                                 // segundo número
